...
function Client(opts) {
  ...
  var timeline = {
    createOrUpdate: function (data, appId, cb) {
      sendRequest({
        method: 'PUT',
        url: self.baseUrl + '/integrations/v1/' + appId + '/timeline/event',
        body: data
      }, cb);
    },
    getTypes: function (appId, cb) {
      sendRequest({
        method: 'GET',
        url: self.baseUrl + '/integrations/v1/' + appId + '/timeline/event-types'
      });
    },
    createType: function (data, appId, cb) {
      sendRequest({
        method: 'POST',
        url: self.baseUrl + '/integrations/v1/' + appId + '/timeline/event-types',
        body: data
    ...
    updateType: function (eventId, data, appId, cb) {
      sendRequest({
        method: 'PUT',
        url: self.baseUrl + '/integrations/v1/' + appId + '/timeline/event-types/' + eventId,
        body: data
      }, cb);
    },
    deleteType: function (eventId, appId, cb) {
      sendRequest({
        method: 'DELETE',
        url: self.baseUrl + '/integrations/v1/' + appId + '/timeline/event-types/' + eventId
      }, cb);
    },
    getTypeProperties: function (eventId, appId, cb) {
      sendRequest({
        method: 'GET',
        url: self.baseUrl + '/integrations/v1/' + appId + '/timeline/event-types/' + eventId + '/properties'
      });
    },
    createTypeProperty: function (eventId, data, appId, cb) {
      sendRequest({
        method: 'POST',
        url: self.baseUrl + '/integrations/v1/' + appId + '/timeline/event-types/' + eventId + '/properties',
        body: data
    ...
    updateTypeProperty: function (eventId, data, appId, cb) {
      sendRequest({
        method: 'PUT',
        url: self.baseUrl + '/integrations/v1/' + appId + '/timeline/event-types/' + eventId + '/properties',
        body: data
    ...
    deleteTypeProperty: function (eventId, propId, appId, cb) {
      sendRequest({
        method: 'DELETE',
        url: self.baseUrl + '/integrations/v1/' + appId + '/timeline/event-types/' + eventId + '/properties/' + propId
      });
    },
  };
